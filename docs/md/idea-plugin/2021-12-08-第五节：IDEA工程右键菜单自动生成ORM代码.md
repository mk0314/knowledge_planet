 ...
 * @Date: 2023-06-08 16:01:36
 * @LastEditors: mengkun822 1197235402@qq.com
 * @LastEditTime: 2023-06-08 16:39:54
 * @FilePath: \knowledge_planet\md\idea-plugin\2021-12-08-第五节：IDEA工程右键菜单自动生成ORM代码.md
...
-   这是一个右键菜单的入口，通过这个入口才能去打开我们自己的 UI 窗体，这个 UI 窗体就是我们上面拖拽出来的配置面板，ORMSettingsUI
